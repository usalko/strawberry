...
from .utils import (get_private_fields, get_strawberry_type_from_model,
                    normalize_type)


def get_type_for_field(field: Field):
...
def field_type_to_type(type_):
    ...
    if is_list(type_):
        ...
        elif issubclass(child_type, Model):
