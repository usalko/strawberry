...
FIELDS_MAP = {
    getattr(fields, field_name): type
...
def get_basic_type(type_) -> Type[Any]:
    # if lenient_issubclass(type_, tortoise_orm_model.ConstrainedInt):
    #     return int
    # if lenient_issubclass(type_, tortoise_orm_model.ConstrainedStr):
    #     return str
    # if lenient_issubclass(type_, tortoise_orm_model.ConstrainedList):
...
def replace_tortoise_orm_model_types(type_: Any, is_input: bool):
...
def replace_types_recursively(type_: Any, is_input: bool) -> Any:
    ...
    replaced_type = replace_tortoise_orm_model_types(basic_type, is_input)
